...
# until curl --silent --fail $JSON_RPC -X 'POST' -H 'Content-Type: application/json' --data "{\"jsonrpc\":\"2.0\", \"id\":1, \"method\": \"net_version\", \"params\": []}"; do sleep 5; done

# extract the variables we need from json output
# MY_ADDRESS="$DEPLOYER_ADDRESS"
